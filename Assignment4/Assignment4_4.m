...
video = VideoReader('finger.mp4');
f = 0;
while hasFrame(video)
    f = f + 1;
    frame = readFrame(video);
    if (f == 45)
        imwrite(frame, 'finger45.png');
    end
    if (f == 46)
        imwrite(frame, 'finger46.png');
    end
end

sigma = 2.0;
image1 = double(rgb2gray(imread('finger45.png')));
image2 = double(rgb2gray(imread('finger46.png')));
